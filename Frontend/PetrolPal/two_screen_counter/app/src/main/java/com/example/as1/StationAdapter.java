...
public class StationAdapter extends RecyclerView.Adapter<StationAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView, RecyclerViewInterface recyclerViewInterface) {
            ...
            stationNameTV = itemView.findViewById(R.id.idStationName);
            stationAddressTV = itemView.findViewById(R.id.idAddress);
            //stationDescriptionTV = itemView.findViewById(R.id.idDescription);
            stationPriceTV = itemView.findViewById(R.id.idPrice);
